...
<li><a href="upload_excelhtml.php" class="active">Student Multiple Entry</a></li>
...
<h2 class="art-postheader">Faculty Multiple Entry</h2>
<iframe src="fac-upload.php" align="middle" frameborder="0" height="850" width="850"></iframe>
