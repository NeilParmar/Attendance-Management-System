...
<body>
<center>
<form name="myform" action="student_delpg2.php" method="post">
<table>
<tr>
<td>
...
<script type="text/javascript">
var spryselect1 = new Spry.Widget.ValidationSelect("spryselect1", {validateOn:["change", "blur"], invalidValue:"-1"});
var spryselect2 = new Spry.Widget.ValidationSelect("spryselect2", {invalidValue:"-1", validateOn:["change", "blur"]});
</script>
</body>
</html>
