...
<body>
<center>
<form action="sub-upload.php" method="post" name="form1" enctype="multipart/form-data">
<input type="file" name="excel" id="excel" onchange="checkFile()" />
<input type="submit" name="submit" value="Submit"/>
<br />
<br />
<a href="Format/SubjectFormat.xlsx">Download the Format File</a>
</form>
</center>
</body>
</html>
 ...
 // echo "Temp file: " . $_FILES['excel']['tmp_name'] . "<br />";
   ...
   if (file_exists("dir/" . $_FILES['excel']['name']))
    ...
    //  echo "Stored in: " . "dir/" . $_FILES['excel']['name'];
	 ...
	 echo"<script>document.location.href = \"sub-display.php\";</script>";
